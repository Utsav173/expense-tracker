...
const PrivacyPolicyPage = () => {
  return (
    <InfoPageLayout
      ...
      icon={<ShieldAlert className='mx-auto mb-4 h-16 w-16 text-sky-500 dark:text-sky-400' />}
    >
      <article className='prose prose-slate dark:prose-invert lg:prose-lg mx-auto'>
        ...
        <p>
          ...
          credentials and AES-GCM encryption for sensitive data like AI API keys. JWTs are used for
          session management. However, remember that no method of transmission over the Internet or
        ...
        <ul>
          <li>
            <strong>With Your Consent:</strong> For example, when you share an account with another
            user.
          </li>
          <li>
            <strong>Service Providers:</strong> We may employ third-party companies and individuals
            to facilitate our Service, provide the Service on our behalf, or perform Service-related
            services. These third parties have access to your Personal Information only to perform
            these tasks on our behalf and are obligated not to disclose or use it for any other
            purpose. (e.g., email provider for notifications).
          </li>
          <li>
          ...
          <li>
            ...
            AI) using your provided API key. Their use of this data is governed by their respective
            privacy policies.
          </li>
        </ul>
        ...
        <p>
          ...
          your account information through your profile settings. For deletion of your entire
