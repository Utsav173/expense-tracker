...
const UpdateModal = <T extends z.ZodRawShape, U = any>({
  ...
  return (
    ...
    >
      ...
      <DialogContent className='mx-auto w-full max-w-[95vw] sm:max-w-[425px]'>
        <DialogHeader>
          <DialogTitle>{title}</DialogTitle>
          <DialogDescription>{description}</DialogDescription>
        </DialogHeader>

        <form onSubmit={handleSubmit(submitAction)} className='max-h-[80vh] overflow-y-auto'>
          ...
          <div className='bg-background sticky bottom-0 mt-4 flex items-center justify-end gap-2 pt-2'>
