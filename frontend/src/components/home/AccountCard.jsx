...
import SmallBalanceChart from './chart/SmallBalanceChart'
  ...
  return (
    ...
    >
      <CardContent orientation='horizontal'>
        ...
        >
          <SmallBalanceChart data={analytics} key={`${cardNumber}-small-account-chart`} />
          <SvgIcon
            sx={{
              position: 'absolute',
              display: 'flex',
      ...
      <CardActions>
        <Button
          ...
          size='sm'
          sx={{
            backgroundColor: theme.palette.mode === 'dark' ? '#374531' : '#13471a',
            fontWeight: 'normal',
        ...
        <Button
          ...
          size='sm'
          sx={{
            backgroundColor: theme.palette.mode === 'dark' ? '#453131' : '#ffd6d6',
            fontWeight: 'normal',
      ...
      {isHovered && (
        ...
        >
          <IconButton onClick={() => dispatch(handleDelete(cardNumber))} disabled={deleteLoading}>
            <DeleteOutlineIcon />
          </IconButton>
          <EditAccountDialog id={cardNumber} name={name} balance={analytics?.balance} />
        </CardOverflow>
      )}
    </Card>
  )
