    ...
    <>
      ...
      <Dialog
        ...
        sx={{
          ...
          '& .MuiDialog-paper': {
            padding: 1,
            borderRadius: theme => (theme.breakpoints.down('md') ? '0px' : '10px'),
            borderBottomLeftRadius: theme => theme.breakpoints.down('md') && '10px',
            borderBottomRightRadius: theme => theme.breakpoints.down('md') && '10px',
      ...
      >
        ...
        <Box component={'form'} onSubmit={handleAddAccount} marginTop={0}>
          ...
          <DialogActions>
            ...
            <Button variant='contained' type='submit' disabled={createLoading} autoFocus>
              Create
            </Button>
          </DialogActions>
        </Box>
