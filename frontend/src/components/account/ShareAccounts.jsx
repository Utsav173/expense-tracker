...
import { fetchDropdownUser, fetchPreviousShares } from '../../redux/asyncThunk/account'
...
const ShareAccounts = ({ accountId }) => {
  ...
  const previousShares = useSelector(state => state.accountPage.previousShares)
  ...
  return (
    <>
      ...
      >
        ...
        <Box component={'form'} onSubmit={handleShareAccountWith} marginTop={0} autoComplete='off'>
          <DialogContent
            sx={{
              paddingBlock: 0
            }}
