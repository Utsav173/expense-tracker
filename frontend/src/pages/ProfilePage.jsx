...
export function ProfilePage() {
  ...
  const { profileData, profileLoading } = useSelector(state => state.profilePage)
  ...
  return (
    <Sidebar isHomepage={false} isLoading={profileLoading}>
            ...
            <CardContent>
              ...
              <Box display='flex' justifyContent='center' alignItems='center' mt={2}>
                ...
                <Typography variant='body2' ml={1}>
                  Last Login At:{' '}
                  {profileData ? new Date(profileData.lastLoginAt).toLocaleString() : 'N/A'}
                </Typography>
              </Box>
            </CardContent>
          </Card>
