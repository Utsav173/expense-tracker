              ...
              <label htmlFor='importfile'>
                <Box
                  sx={{
                    ...
                    py: 1,
                    my: 'auto',
                    borderColor: theme => (theme.palette.mode === 'dark' ? '#5f5f5f' : '#0000003b'),
                    color: theme => theme.palette.primary.main,
                    textDecoration: 'none',
                    transition: 'color 0.3s',
                    '&:hover': {
                      color: theme => (theme.palette.mode === 'dark' ? '#90f9b9' : '#0089fa')
                    }
                  }}
                >
                  <Typography variant='body1' component='div'>
                    {importFile ? `${importFile.name?.slice(0, 20)}...` : 'Profile Pic'}
                  </Typography>
                </Box>
                {importFile && (
                  <FormHelperText>
