    ...
    createCategory: tool({
      ...
      parameters: z.object({
        categoryName: z
          .string()
          .min(1)
          .describe("The name for the new category (e.g., 'Freelance Income', 'Office Lunch'). Example: "New Category Name""),
      }),
    ...
    listCategories: tool({
      ...
      parameters: z.object({
        searchName: z
          .string()
          .optional()
          .describe('Optional: Filter categories whose name contains this text. Example: "Food" or "Travel"'),
      }),
