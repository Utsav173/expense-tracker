...
<Step number={2} title='Save Your Key in Expense Pro'>
  Navigate to your **Profile** page (by clicking your avatar in the sidebar), then go to the **AI Assistant** tab. Paste your copied key into the field and click **Save Key**. The AI Assistant will be enabled immediately across the app.
</Step>

<Alert>
  Your API key is stored securely in our database using strong AES-GCM encryption. It is only ever decrypted on the server when needed to process your AI requests on your behalf. We never see or log your raw key.
</Alert>