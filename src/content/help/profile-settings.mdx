...
### <Icon name="userCircle2" /> Profile Tab

This is where you manage your personal information.

<Step number={1} title='Update Your Identity'>
  Here you can change your **Full Name** and update your **Profile Picture**. Click the camera icon <Icon name='camera' className='inline h-4 w-4' /> on your avatar to upload a new image.
</Step>
