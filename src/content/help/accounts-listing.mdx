...
<Step number={3} title='Perform Actions on an Account'>
  ...
  - **Edit <Icon name='edit' className='inline h-4 w-4' />:** Opens a modal to update the account's name, balance, or default status.
  - **Delete <Icon name='trash' className='inline h-4 w-4' />:** Opens a confirmation dialog to delete the account.
  - **Share <Icon name='share2' className='inline h-4 w-4' />:** Takes you to a page to manage sharing for that specific account.
</Step>
