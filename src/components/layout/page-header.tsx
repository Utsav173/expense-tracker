...
const PageHeader: React.FC = () => {
  ...
  return isDashboard ? null : (
    <header className='bg-sidebar/50 sticky top-0 z-35 flex h-16 shrink-0 items-center gap-2 backdrop-blur-md transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12'>
