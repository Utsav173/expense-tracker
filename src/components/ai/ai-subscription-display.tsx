...
const AiSubscriptionDisplay: React.FC<AiSubscriptionDisplayProps> = React.memo(
  ({ subscriptions }) => {
        ...
        <Card className='mt-0'>
          ...
          <CardContent>
            <p className='text-muted-foreground mb-4 text-sm'>
              Found {subscriptions.length} potential recurring subscriptions from the last 12
              months.
            </p>
            <Table>
              <TableHeader>
